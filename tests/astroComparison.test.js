...
test('computePositions matches AstroSage for Darbhanga 1982-12-01 03:50', async () => {
  ...
  assert.deepStrictEqual(snapshot, [
    ...
    { tag: 'text', attrs: { x: '0.5', y: '0.32', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "saturn(R) 29°14'" },
    { tag: 'text', attrs: { x: '0.25', y: '0.15333333333333332', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "sun 14°46'" },
    { tag: 'text', attrs: { x: '0.25', y: '0.19333333333333333', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "jupiter(R) 25°04'" },
    ...
    { tag: 'text', attrs: { x: '0.5', y: '0.8200000000000001', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "venus 10°02'" },
    { tag: 'text', attrs: { x: '0.69', y: '0.98', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "moon(Ex) 13°17'" },
    { tag: 'text', attrs: { x: '0.69', y: '0.94', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "mercury(R) 29°13'" },
