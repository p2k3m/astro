...
test('computePositions matches AstroSage for Darbhanga 1982-12-01 03:50', async () => {
  ...
  assert.deepStrictEqual(snapshot, [
    ...
    { tag: 'text', attrs: { x: '0.33', y: '0.08', 'text-anchor': 'start', 'font-size': '0.03' }, text: 'Asc' },
    { tag: 'text', attrs: { x: '0.5', y: '0.1', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '7' },
    { tag: 'text', attrs: { x: '0.4', y: '0.08', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '8' },
    { tag: 'text', attrs: { x: '0.08', y: '0.1', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '9' },
    { tag: 'text', attrs: { x: '0.25', y: '0.35', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '10' },
    { tag: 'text', attrs: { x: '0.08', y: '0.6', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '11' },
    { tag: 'text', attrs: { x: '0.25', y: '0.83', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '12' },
    { tag: 'text', attrs: { x: '0.5', y: '0.6', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '1' },
    { tag: 'text', attrs: { x: '0.75', y: '0.83', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '2' },
    { tag: 'text', attrs: { x: '0.92', y: '0.6', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '3' },
    { tag: 'text', attrs: { x: '0.75', y: '0.35', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '4' },
    { tag: 'text', attrs: { x: '0.92', y: '0.1', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '5' },
    { tag: 'text', attrs: { x: '0.9', y: '0.08', 'text-anchor': 'middle', 'font-size': '0.05' }, text: '6' },
