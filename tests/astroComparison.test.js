...
test('computePositions matches AstroSage for Darbhanga 1982-12-01 03:50', async () => {
  ...
  assert.deepStrictEqual(snapshot, [
    ...
    { tag: 'text', attrs: { x: '0.96', y: '0.08', 'text-anchor': 'end', 'font-size': '0.05' }, text: '8' },
    { tag: 'text', attrs: { x: '0.96', y: '0.08', 'text-anchor': 'end', 'font-size': '0.05' }, text: '9' },
    { tag: 'text', attrs: { x: '0.96', y: '0.33', 'text-anchor': 'end', 'font-size': '0.05' }, text: '10' },
    { tag: 'text', attrs: { x: '0.96', y: '0.58', 'text-anchor': 'end', 'font-size': '0.05' }, text: '11' },
    { tag: 'text', attrs: { x: '0.96', y: '0.83', 'text-anchor': 'end', 'font-size': '0.05' }, text: '12' },
    { tag: 'text', attrs: { x: '0.71', y: '0.58', 'text-anchor': 'end', 'font-size': '0.05' }, text: '1' },
    { tag: 'text', attrs: { x: '0.46', y: '0.83', 'text-anchor': 'end', 'font-size': '0.05' }, text: '2' },
    { tag: 'text', attrs: { x: '0.21', y: '0.58', 'text-anchor': 'end', 'font-size': '0.05' }, text: '3' },
    { tag: 'text', attrs: { x: '0.46', y: '0.33', 'text-anchor': 'end', 'font-size': '0.05' }, text: '4' },
    { tag: 'text', attrs: { x: '0.21', y: '0.08', 'text-anchor': 'end', 'font-size': '0.05' }, text: '5' },
    { tag: 'text', attrs: { x: '0.46', y: '0.08', 'text-anchor': 'end', 'font-size': '0.05' }, text: '6' },
    { tag: 'text', attrs: { x: '0.5', y: '0.32', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "saturn(Ex) 00°14'" },
    { tag: 'text', attrs: { x: '0.75', y: '0.15333333333333332', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "sun 14°46'" },
    { tag: 'text', attrs: { x: '0.75', y: '0.19333333333333333', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "jupiter(C) 05°04'" },
    { tag: 'text', attrs: { x: '0.9166666666666666', y: '0.32', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "ketu(R) 11°53'" },
    { tag: 'text', attrs: { x: '0.75', y: '0.98', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "mars 08°19'" },
    ...
    { tag: 'text', attrs: { x: '0.25', y: '0.98', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "moon(Ex) 13°17'" },
    { tag: 'text', attrs: { x: '0.08333333333333333', y: '0.8200000000000001', 'text-anchor': 'middle', 'font-size': '0.03' }, text: "rahu(R) 11°53'" },
  ]);
});
