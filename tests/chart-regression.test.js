...
test('computePositions matches AstroSage for Darbhanga 1982-12-01 03:50', async () => {
  ...
  assert.deepStrictEqual(snapshot, [
    ...
    { tag: 'text', attrs: { x: '0.25', y: '0.15333333333333332', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'sun 14°46′28″' },
    { tag: 'text', attrs: { x: '0.25', y: '0.17888888888888888', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'mercury(R) 29°13′15″' },
    { tag: 'text', attrs: { x: '0.25', y: '0.20444444444444443', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'venus 10°02′30″' },
    { tag: 'text', attrs: { x: '0.25', y: '0.22999999999999998', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'jupiter(R) 25°03′25″' },
    { tag: 'text', attrs: { x: '0.08333333333333333', y: '0.32', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'ketu(R) 11°53′18″' },
    { tag: 'text', attrs: { x: '0.19', y: '0.98', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'mars 08°19′13″' },
    { tag: 'text', attrs: { x: '0.69', y: '0.98', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'moon(Ex) 13°16′59″' },
    { tag: 'text', attrs: { x: '0.9166666666666666', y: '0.8200000000000001', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'rahu(R) 11°53′18″' },
    { tag: 'text', attrs: { x: '0.75', y: '0.15333333333333332', 'text-anchor': 'middle', 'font-size': '0.03' }, text: 'saturn(R) 29°14′20″' },
  ]);
});
